  ...
  function ServiceImpl(LogService, Util) {
    ...
    function getFileEntry(fileName) {
      var promise = new Promise(function(resolve, reject) {
        ...
        var fGetStorageDirEntry = util.isBrowser() ? getFileSystem : getAppDataDir;
    ...
    function getFileSystem() {
      var promise = new Promise(function(resolve, reject) {
        ...
        var FileType = LocalFileSystem.PERSISTENT; //LocalFileSystem.TEMPORARY
        var FileSize = 5*1024*1024; // 1 Mb ?
    ...
    function internal_write(writer, objData) {
      var promise = new Promise(function(resolve, reject) {
        ...
        var blob = new Blob([objData], { type: 'application/json' });
        writer.write(blob);
      });
